        ...
        if prediction == 1:
            ...
            st.markdown(f"""
                <div style='background-color:#F8D7DA; padding:25px; border-radius:15px; text-align:center;'>
                    ...
                    <p style <p style='font-size:18px; color:#721C24;'> Your health Probability: <b>{100-prob:.1f}%</b><br>and you are at risk of lifestyle diseases. Consider making healthier choices.</p>
                </div>
            """, unsafe_allow_html=True)
