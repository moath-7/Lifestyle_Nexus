...
def results_page():
    ...
    if 'prediction' in st.session_state:
        ...
        if prediction == 1:
            st.success(f"✅ Your lifestyle is healthy with a probability of {prob:.1f}% ! Keep up the good work maintaining a healthy lifestyle.")
        else:
            st.error(f"⚠️ Your lifestyle is unhealthy (Health probability {prob:.1f}%) and you are at risk of lifestyle diseases. Consider making healthier choices.")
    else:
